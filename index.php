...
<header class="header">
   ...
   <a class="logo"><img src="img/logol.png" alt="logo"></a>
   </div>
        <div class="col-md-12 text-center">
...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>IvoireLux</h3>
   <div class="row">
<!--carousel-->
     <div class="col-sm"><br><br>
        ...
        <div class="carousel-inner">
           <div class="carousel-item active">
             <img class="d-block w-100" src="img/plat1.jpg" alt="First slide">
           </div>
           <div class="carousel-item">
           <img class="d-block w-100" src="img/plat2.jpg" alt="Second slide">
           </div>
           <div class="carousel-item">
    ...
    <h3 class="text-center"><br>Gallery<br><br></h3>
        <div class="d-flex flex-row flex-wrap justify-content-center">
           <div class="d-flex flex-column">
              <img src="img/plat2.jpg" class="img-fluid">
              <img src="img/2.png" class="img-fluid">
           </div>
           <div class="d-flex flex-column">
              <img src="img/3.jpeg" class="img-fluid">
              <img src="img/plat3.jpg" class="img-fluid">
           </div>
           <div class="d-flex flex-column">
               <img src="img/4.jpeg" class="img-fluid">
               <img src="img/plat1.jpg" class="img-fluid">
           </div>
           <div class="d-flex flex-column">
...
<div class="container" id="reservation">
    ...
    <img  src="img/res.png" class="img-fluid rounded" width="150%" height="100%">
...
<section class="map" id="footer">
    ...
    <h3 class="text-center"><br><br>Find us!</h3><br>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3971.87613318706!2d-4.014452185415194!3d5.435777196057749!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc195f22bddf4ff%3A0x4ba51881b1345a49!2splaque%201!5e0!3m2!1sfr!2sci!4v1616719999264!5m2!1sfr!2sci" width="1200" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
?>
            ...
            <p class="text-right">IvoireLux<br><i class="fa fa-map-marker"></i>&nbsp; Cote d'ivoire.Abidjan, <br>Abobo plaque1 <br><br>email: ba3366606@gmail.com<br>phone: +225 0546558133</p>
            </div>
